![GitHub Workflow Status (branch)](https://img.shields.io/github/workflow/status/savannabits/np-typeorm-pagination/npm-publish/master?label=npm-publish&style=flat-square)
